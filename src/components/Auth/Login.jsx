function Login() {
    return (
        <div style={{
            ...
            <div className="border border-success rounded-3 shadow-lg p-2 mx-auto w-50" style={{backgroundColor: "rgb(243 244 246)"}}>
                ...
                <form className="d-flex flex-column px-3">
                    ...
                    <button className="btn btn-success m-5 p-2 rounded-3 shadow" type="submit">Ingresar</button>
                </form>
            </div>
        </div>
    )
